...
public class GenerateAst {
    public static void main(String[] args) throws IOException {
         ...
         defineAst(outputDir, "Stmt", Arrays.asList("Block : List<Stmt> statements", "ClassDef : Token name, List<Stmt.Function> methods", "Expression : Expr expression", "Function : Token name, List<Token> params, List<Stmt> body", "IfCondition : Expr condition, Stmt thenBranch," + " Stmt elseBranch", "Print : Expr expression","ReturnStmt : Token keyword, Expr value", "Var : Token name, Expr initializer", "WhileLoop : Expr condition, Stmt body"));
    }
